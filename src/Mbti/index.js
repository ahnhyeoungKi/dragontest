...
const Mbti =  (()=> {
  ...
  const questionList = [
    ...
    {q:['2024년 애인이 나를 위해 새해 이벤트를 준비했다면 그에 대한 나의 반응은?'],
    a:[{type:'T',text:'고마워 요즘 바쁠 텐데 언제 이런 걸 생각했어? '},{type:'F',text:'사랑해 최고야 너밖에 없어 나 정말 감동했어...'}]},
   
    {q:['연인과 싸운 나 친구들에게 애인에 대한 불만을 친구들에게 어떻게 토로했을까?'],
    a:[{type:'F',text:'내 마음을 몰라주네~ 왜 내 마음을 몰라?ㅠㅠ '},{type:'T',text:'문제가 있을 때 어떤 문제인지 해결해줬는데 왜 화내는거야?'}]},
  ...
  function setMbti() {
    let ls = mbtiList
    let mc = [
      {mbti:'ENFJ',img:ENFJ,animal:'다줄거야~~',animal2:'다줄게용',contents:['좋아하는 사람에게 잘함 그 만큼 상처도 많이 받음','주변 사람들을 챙기는 것을 좋아하고 기뻐하는 것을 보면 행복해함','리액션 장인','타인의 감정 상태나 미세한 감정 표현도 빠르게 캐치하는 능력이 있음','의사소통에 능해서 생각을 표현하는 것을 잘함','활발하고 인간관계에 능해서 리더 역할을 해줌','다정한 편이지만 감정적으로 배신감을 느끼면 얄짤 없음','상대방이 나를 신뢰할 때 살아있음을 느낌','계획을 세우고 그 계획대로 행복하고 싶어함',]},

      {mbti:'ENFP',img:ENFP,animal:'노는게 가장 좋은',animal2:'노라용',contents:['감정 표현이 직설적이고 솔직해요(자기주장이 강해요)','자기 자신을 신뢰하면 인생을 살아요','감성팔이 절대 안 먹히는 단호박 중에 단호박이예요','일 처리를 확실하고 완벽하게 하는 편이예요','일 못하고 무능한 것을 싫어해 내가 답답해서 그냥 내가 해요','내 일은 내 일 니 일은 니 일이예요','남이 이래라 저래라 하는 것을 극혐해요','은혜는 10배로 원수는 100배로 되값아줘요','열등감을 잘 느끼지 않아 세상 별의별 욕 다 들어도 별로 타격 없어요']},
