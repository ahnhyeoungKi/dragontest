...
const Mbti =  (()=> {
  ...
  const questionList = [
    ...
    {q:['일에 대한 고민이 생겼다, 지인들과 어디까지 얘기를 할까?'],
    a:[{type:'E',text:'내가 생각지도 못한 결과물이 나올 수 있기에 지인들에게 고민 상담을 최대한 한다.'},{type:'I',text:'아주 가까운 친구 1명에게만 고민 상담을 한다.'}]},
    ...
    a:[{type:'S',text:'누구 계좌에 각자 얼마를 넣을지 먼저 얘기한다. '},{type:'N',text:'모임 통장으로 앞으로 어떻게 쓸 것인지 먼저 얘기힌다.'}]},
     
    {q:['내가 더 좋아하는 사람의 유형이 이 중에 있다면?'],
    a:[{type:'N',text:'내가 하는 아이디어가 세상에 빛이 될 것 같아'},{type:'S',text:'지금 불편한 상황을 해결 한번 해보자'}]},
      
    {q:['2024년 남자친구/여자친구가 나를 위한 새해 이벤트를 준비했다면 내가 할 칭찬은?'],
    a:[{type:'T',text:'고마워 요즘 바쁠 텐데 언제 이런 걸 생각했어? '},{type:'F',text:'사랑해 최고야 너밖에 없어 나 정말 감동했어...'}]},
   
    {q:['연인과 싸운 나 친구들에게 얘기를 하며 불만을 얘기했다면?'],
    ...
    {q:['SNS핫한 명소를 가기로 한 나, 나의 룩을 고를 때 나는?'],
